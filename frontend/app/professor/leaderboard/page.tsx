...
export default function ProfessorLeaderboard() {
  ...
  return (
    <div className="min-h-screen bg-brand-bg pl-64 flex flex-col text-brand-text">
      <Sidebar activePath="/professor/leaderboard" />
      <main className="p-8 flex-grow w-full max-w-4xl">
        <div className="mb-8">
          <h1 className="text-3xl font-extrabold tracking-tight">Class Leaderboard</h1>
          <p className="text-brand-muted text-sm mt-1">Classroom leaderboard showing the top 20 scoring student network engineers.</p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-brand-card border border-brand-border rounded-xl p-8 text-center text-brand-muted text-sm">
            No students are currently ranked. Make sure student accounts are approved and they complete curriculum activities!
          </div>
        ) : (

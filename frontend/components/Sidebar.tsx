  ...
  return (
    <aside className="w-64 bg-brand-bg border-r border-brand-border h-screen flex flex-col fixed left-0 top-0 text-sm">
      ...
      <div className="p-4 border-t border-brand-border/30 space-y-2">
        <Link href="#" className="flex items-center gap-3 px-4 py-2 rounded-md font-medium text-brand-muted hover:bg-brand-card hover:text-brand-text transition-colors">

...
export default function Sidebar({ activePath }: { activePath: string }) {
  ...
  if (activePath.includes('/professor')) {
    menuItems.push({ name: 'Students', path: '/professor/students', icon: <><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></> });
  }

  return (
    <aside className="w-64 bg-brand-bg border-r border-brand-border h-screen flex flex-col fixed left-0 top-0 text-sm">
      <div className="p-6 pb-8 border-b border-brand-border/30">
        ...
        <div className="text-[10px] text-brand-muted tracking-wide">Elite Networking</div>
      </div>
